...
define([
    ...
    function petri_vizControl(options) {
    ...
    petri_vizControl.prototype._initWidgetEventHandlers = function () {
    ...
    petri_vizControl.prototype.selectedObjectChanged = function (nodeId) {
        var self = this;
    ...
    /* * * * * * * * Node Event Handling * * * * * * * */
    petri_vizControl.prototype._eventCallback = function (events) {
        const self = this;
        console.log(events);
    ...
    petri_vizControl.prototype._stateActiveObjectChanged = function (model, activeObjectId) {
    ...
    petri_vizControl.prototype._initSM = function () {
        const self = this;
    ...
    petri_vizControl.prototype.clearSM = function () {
        const self = this;
        self._networkRootLoaded = false;
        self._widget.destroyMachine();
    };

    petri_vizControl.prototype.setFireableEvents = function (events) {
    ...
    petri_vizControl.prototype.destroy = function () {
        this._detachClientEventListeners();
        this._removeToolbarItems();
    };

    petri_vizControl.prototype._attachClientEventListeners = function () {
        this._detachClientEventListeners();
        WebGMEGlobal.State.on('change:' + CONSTANTS.STATE_ACTIVE_OBJECT, this._stateActiveObjectChanged, this);
    };

    petri_vizControl.prototype._detachClientEventListeners = function () {
        WebGMEGlobal.State.off('change:' + CONSTANTS.STATE_ACTIVE_OBJECT, this._stateActiveObjectChanged);
    };

    petri_vizControl.prototype.onActivate = function () {
    ...
    petri_vizControl.prototype.onDeactivate = function () {
        this._detachClientEventListeners();
        this._hideToolbarItems();
    };

    /* * * * * * * * * * Updating the toolbar * * * * * * * * * */
    petri_vizControl.prototype._displayToolbarItems = function () {
    ...
    petri_vizControl.prototype._hideToolbarItems = function () {
    ...
    petri_vizControl.prototype._removeToolbarItems = function () {
    ...
    petri_vizControl.prototype._initializeToolbar = function () {
        var self = this,
        ...
        this.$btnGraphTheory = toolBar.addButton({
            title: 'Low Level Graph Details',
            icon: 'glyphicon glyphicon-question-sign',
            clickFn: function (/*data*/) {
                const context = self._client.getCurrentPluginContext('GraphTheory',self._currentNodeId, []);
        ...
        this._toolbarItems.push(this.$btnGraphTheory);
