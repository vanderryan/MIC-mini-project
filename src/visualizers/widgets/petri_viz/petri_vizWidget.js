...
define(['jointjs', 'css!./styles/petri_vizWidget.css'], function (joint) {
    'use strict';
    ...
    petri_vizWidget.prototype.initMachine = function (machineDescriptor) {
        const self = this;
    ...
    petri_vizWidget.prototype.destroyMachine = function () {

    };

    petri_vizWidget.prototype.fireEvent = function (event) {
        const self = this;
    ...
    petri_vizWidget.prototype.resetMachine = function () {
        this._webgmeSM.current = this._webgmeSM.init;
        this._decorateMachine();
    };

    petri_vizWidget.prototype._decorateMachine = function() {
    ...
    petri_vizWidget.prototype._setCurrentState = function(newCurrent) {
